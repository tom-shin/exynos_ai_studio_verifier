...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.memoryprofilewidget = QtWidgets.QWidget(self.groupBox_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.memoryprofilewidget.sizePolicy().hasHeightForWidth())
        self.memoryprofilewidget.setSizePolicy(sizePolicy)
        self.memoryprofilewidget.setObjectName("memoryprofilewidget")
        self.verticalLayout_15 = QtWidgets.QVBoxLayout(self.memoryprofilewidget)
        self.verticalLayout_15.setObjectName("verticalLayout_15")
        self.verticalLayout_13.addWidget(self.memoryprofilewidget)
        ...
        self.memorytextEdit = QtWidgets.QTextEdit(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_7.addWidget(self.memorytextEdit, 1, 1, 1, 1)
